...
{
    public class SorensenDiceCoefficientSearchService : JsonFileSource<SorensenDiceCoefficientIndex<int>>, ISearchService
    {
        public string Name { get; }

        public SorensenDiceCoefficientSearchService(string name)
        {
            Name = name;
        }
